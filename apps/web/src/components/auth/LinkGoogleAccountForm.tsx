...
function HiddenPasswordEyeIcon() {
  return (
    <svg
      aria-hidden="true"
      xmlns="http://www.w3.org/2000/svg"
              ...
              <form onSubmit={handleSubmit} noValidate className="mt-6">
                <label htmlFor="password">
                  <span className="mb-2 block font-sans text-sm font-normal leading-[22px] text-neutral-10">
                    Zionra Password <span className="text-error">*</span>
                  </span>
                  <span
                    className={`zion-input-shell h-[52px] md:h-12 ${
                      passwordError ? "zion-input-shell-error" : ""
                    }`}
                  >
                    <input
                      id="password"
                    ...
                    >
                      {showPassword ? (
                        <VisiblePasswordEyeIcon />
                      ) : (
                        <HiddenPasswordEyeIcon />
                      )}
                    </button>
                  </span>
                </label>
                ...
                {passwordError ? (
                  <p className="zion-field-error mt-1">{passwordError}</p>
                ) : null}
